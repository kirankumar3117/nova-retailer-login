<template >
    <div >
        <div class="otpContainer">
            ...
            <p class="bg-transparent mt-3" v-if="!data.success">You have entered an invalid {{ data.errorPropsMobile ? 'Number' : 'OTP' }} <br/>Please enter a valid {{ data.errorPropsMobile ? 'Mobile Number' : 'OTP' }}</p>
